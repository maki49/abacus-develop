...
void Exx_LRI_Interface<T, Tdata>::exx_hamilt2density(elecstate::ElecState& elec, const Parallel_Orbitals& pv)
{
    ...
    if (XC_Functional::get_func_type() == 4 || XC_Functional::get_func_type() == 5)
    {
            ...
            && !GlobalC::restart.info_load.restart_exx)
        {
            ...
            if (this->exx_spacegroup_symmetry && GlobalC::exx_info.info_global.exx_symmetry_realspace)
                this->exx_ptr->cal_exx_elec(Ds, pv, &this->symrot_);
            else
    ...
    if (GlobalC::exx_info.info_global.cal_exx)
    {
        ...
        else
        {
            ...
            // this->symrot_.print_HR(this->exx_ptr->Hexxs[0], "Hexxs_restored", 1e-10);   // test
                ...
                this->exx_ptr->cal_exx_elec(Ds, *dm.get_paraV_pointer());
            //this->symrot_.print_HR(this->exx_ptr->Hexxs[0], "Hexxs_ref", 1e-10);
            // this->symrot_.print_HR(this->exx_ptr->Hexxs[0], "Hexxs_restore-DM-only", 1e-10);   // test
