        ...
        const bool skip_charge)
    {
        ...
        else
        {
            ...
            if (this->method == "dav")
            {
                ...
                DiagoIterAssist<T, Device>::avg_iter += static_cast<double>(david.diag(pHamilt,
                    psi_k1_dav,
                    eigenvalue.data(),
                    this->diag_ethr,
                    david_maxiter,
            ...
            {
                Diago_DavSubspace<T, Device> dav_subspace(precondition,
                ...
                auto subspace_func = [pHamilt](T* psi_out,
                    ...
                    const int nbasis_max_in) {
                        ...
                        DiagoIterAssist<T, Device>::diagH_subspace(pHamilt,
                            psi_in_wrapper,
                            psi_out_wrapper,
