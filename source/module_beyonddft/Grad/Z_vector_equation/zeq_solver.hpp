...
namespace hamilt
{
        ...
        Parallel_Orbitals& pmat)
    {
        ...
        psi::Psi<T> R(kv.nks, nstates, px.get_local_size(), nullptr, false);
        hamilt::Z_vector_R<T> ops_R(nspin, naos, nocc, nvirt,
            ucell, GlobalC::GridD, psi_ks, eig_ks,
#ifdef __EXX
            exx_lri,
#endif 
        ...
        hamilt::Z_vector_L<T> ops_L(nspin, naos, nocc, nvirt,
            ucell, GlobalC::GridD, psi_ks, eig_ks,
#ifdef __EXX
            exx_lri,
#endif 
        ...
        psi::Psi<T> Z(kv.nks, nstates, px.get_local_size(), nullptr, false);
        solve_Z_CG(Z, R,
            std::bind(static_cast<void(Operator<T>::*)(const psi::Psi<T>&, psi::Psi<T>&) const>(&Operator<T>::hPsi),
